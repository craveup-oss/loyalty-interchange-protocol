...
See the complete [security and operations document on GitHub](https://github.com/craveup-oss/loyalty-interchange-protocol/blob/main/docs/security-and-operations.md).
