...
<Tabs>
  <Tab title="Docker">
    ...
    Then open [Admin](http://127.0.0.1:3210/admin/) with the printed key (`lip-local-compose-key-change-me` in the local-only Compose profile) and the visibly synthetic [guest wallet](http://127.0.0.1:3230/).
  </Tab>
  <Tab title="Source">
